...
# Minimise negative log-likelihood with optim # [ ] - Needs updating as should be constrained optimization, which I think requires specification of the gradient of the likelihood
res <- optim(c(0.06,4e-4),seroprev_negative_log_likelihood,x=seroprev) #method="L-BFGS-B",lower=c(0,0),upper=c(1,100),
saveRDS(res,"../Data/seroprev_pars.RDS")
