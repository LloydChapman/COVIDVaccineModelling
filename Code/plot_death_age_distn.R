...
## CDC US data
# Read in data
deaths <- read.csv("CDCDeathsData/Provisional_COVID-19_Death_Counts_by_Sex__Age__and_State.csv",stringsAsFactors = F)
...
plot_deaths(CAdeaths,"CA_death_age_distn")
...
plot_deaths(CAdeaths1,"CA_death_age_distn1")
