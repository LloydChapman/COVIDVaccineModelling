...
# df <- load_synth_pop("../Data/Simulation1126/",county_names)
...
p_death <- readRDS("../Data/prob_death_given_clin_by_age_and_sex_2020-07-19_1.RDS")

# Read in life table data frame
lt_long <- read.csv("../Data/US_life_table.csv",stringsAsFactors = F)
...
saveRDS(df,"../Data/CA_pop_with_risk_ests1.RDS")